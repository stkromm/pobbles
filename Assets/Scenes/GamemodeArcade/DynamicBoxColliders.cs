...
public class DynamicBoxColliders : MonoBehaviour {
    ...
    void CreateBoxColliders()
    {
        ...
        screenSize.y = (1f-topBottomMarginPercentage)*(Vector2.Distance(Camera.main.ScreenToWorldPoint(new Vector2(0, 0)), Camera.main.ScreenToWorldPoint(new Vector2(0, Screen.height))) * 0.5f);
